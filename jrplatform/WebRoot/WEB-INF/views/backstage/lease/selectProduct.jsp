...
<script type="text/javascript">
	...
	function _confirm(ids){
		...
		$.ajax( {
			type : "post",
			url : "${pageContext.servletContext.contextPath}/lease/confirmScroll",
			dataType:"json",
			data:"ids="+ids,
			contentType: "application/x-www-form-urlencoded; charset=UTF-8",
			success : function(msg) {
				if((msg.success+"") == "true"){
					...
					closeHandler();
					window.parent.loading("${pageContext.servletContext.contextPath}/lease/scrollListJump");
				}else{
					$("#loading").fadeOut();
					window.parent.alert(msg.message);	
				}
	...
	function closeHandler(){window.parent.remove("selectProductJump");}
