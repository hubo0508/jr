          ...
          <tr>
            ...
            <td valign="top" height="100%">
                ...
                <div id="loading_box" style="top:0px; height:100%; width:86.6%">
                	<span><img src="${pageContext.request.contextPath}/resources/backstage/image/loading/24.gif" style="margin-bottom:-12px;"/>&nbsp;正在加载，请稍后</span>
                </div>
            </td>
        </tr>
    </table>
...
<script type="text/javascript">
	...
	$(document).ready(function(){				   
		...
		opt.projectname = "${pageContext.servletContext.contextPath}"
		opt.menu = eval('(' + '${menu}' + ')');
